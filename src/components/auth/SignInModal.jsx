...
export const SignInModal = ({ open, onClose, onSwitch }) => {
  const { login, sendLoginOtp, loginWithOtp, loginWithGoogle } = useAuth();
  ...
  useEffect(() => {
    if (open && window.google && googleBtnRef.current) {
        ...
        <div className="p-8">
          ...
          <div className="mt-6 flex items-center justify-between">
            <button
              ...
              className="text-sm font-medium text-gray-600 hover:text-orange-600 transition-colors cursor-pointer"
            >
